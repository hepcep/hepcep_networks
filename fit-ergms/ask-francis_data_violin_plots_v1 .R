...
# Load in Data ----------
load("/project2/khanna7/francis/HepCep/sim100networks.indeg02.RData")
...
d1_plot <- ggplot(d1, aes(x=distance, y=count, fill=distance))
d2_plot <- ggplot(ione.data, aes(x=distance, y=count, fill=distance))
d3_plot <- ggplot(itwo.data, aes(x=distance, y=count, fill=distance))
d4_plot <- ggplot(ithree.data, aes(x=distance, y=count, fill=distance))
dfull_plot <- ggplot(full_distance, aes(x=distance, y=count, fill=distance)) + 
  geom_boxplot()
